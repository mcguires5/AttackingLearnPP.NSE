...
% @Last Modified time: 2019-05-09 00:09:48
function [NseResults,varargout] = AttackingLearnPlusPlusDotNSE(DataSet,AttackMethod,Kernel,varargin)
	...
	[GenDistr(1:WindowSize-1).Data] = deal(0);
	[GenDistr(1:WindowSize-1).Labels] = deal(0);
	[AtkData(1:WindowSize-1).Points] = deal(0);
	[AtkData(1:WindowSize-1).Labels] = deal(0);
