...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [xc err xc_seq alphac_seq xi_obj]= attack_linear_SVM(step, xc, yc, lb, ub, x_tr, y_tr, x_vd, y_vd, C)
...
for i=1:500
    ...
    dxc = attackSVMshift(x_tr,y_tr,x_tr(end,:),yc,margin_SV_idx,g,Q,Q_tst,x_vd,y_vd,alpha(end)); 
    xc = xc+step*dxc;
