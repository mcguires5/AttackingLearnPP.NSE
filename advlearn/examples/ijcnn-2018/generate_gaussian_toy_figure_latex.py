...
def main():
    ...
    plt.savefig('gaussian_toy_objective.pdf')
    plt.savefig('gaussian_toy_objective.eps')
    ...
    plt.savefig('gaussian_toy_classification.pdf')
    plt.savefig('gaussian_toy_classification.eps')
