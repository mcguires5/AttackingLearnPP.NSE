...
def fit_attack(X, y):
    attack = GeneralTikhonovAttack(step_size=150, max_steps=5000,
                                   lasso_lambda=0.02,
                                   boundary=boundary,
...
def main():
    ...
    plt.savefig('gaussian_toy_kthdistance_objective.pdf')
    plt.savefig('gaussian_toy_kthdistance_objective.eps')
    ...
    plt.savefig('gaussian_toy_kthdistance_classification.pdf')
    plt.savefig('gaussian_toy_kthdistance_classification.eps')
